...
![](https://raw.githubusercontent.com/rstudio/cheatsheets/master/pngs/thumbnails/lubridate-cheatsheet-thumbs.png)
---
...
```{r}
library(lubridate)
x <- c("2018-01-01 12:00:00", "2018/1/1 12.00.00")
...
```{r}
as_datetime(x)
as_datetime(x) %>% with_tz("Asia/Seoul")
```
]
